        ...
        <form action="/dashboard/faq/{{ $faq->id }}" method="POST">
            ...
            <div class="mb-3">
                ...
                @error('pertanyaan')
                    is-invalid
                @enderror"
                    id="pertanyaan" name="pertanyaan" autofocus value="{{ old('pertanyaan', $faq->pertanyaan) }}">
                @error('pertanyaan')
            ...
            <div class="mb-5">
                ...
                ">Deskirpsi</label>
                <input id="deskripsi" type="hidden" name="deskripsi" value="{{ old('deskripsi', $faq->deskripsi) }}"
                    required>
