...
@section('container')
    <div class="create-container w-75 mt-5 ml-5 p-3">
        ...
        <form action="/dashboard/ongkos-kirim" method="POST">
            @csrf
            <div class="mb-3">
                ...
                @error('daerah')
                    is-invalid
                @enderror"
                    id="daerah" name="daerah" autofocus value="{{ old('daerah') }}">
                @error('daerah')
            ...
            <div class="mb-3">
                ...
                is-invalid
            @enderror"
                    type="number" name="harga_ongkir" id="harga_ongkir_input" value="{{ old('harga_ongkir') }}">
                @error('harga_ongkir')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
